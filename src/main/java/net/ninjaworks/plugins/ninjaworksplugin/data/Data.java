package net.ninjaworks.plugins.ninjaworksplugin.data;
...
public class Data implements Serializable {
    ...
    public static void getBlocksPlayersAndSave() {
        ...
        new Data(blockSnapShot, previouslyOnlinePlayers).saveData("ninjaworksplugin.data");
    ...
    public static void welcomePlayersAndResetBlocks() {
        ...
        Data data = new Data(Data.loadData("ninjaworksplugin.data"));
